...
# highest temp in china
china = 123
# highest temp in india
india = 124
# highest temp in us
united_states = 134
...
india = 124
united_states = 134
china_celsius = (china - 32) * float(0.56)
india_celsius = (india - 32) * float(0.56)
us_celsius = (united_states - 32) * float(0.56)

def f_to_c(f):
    c = (f - 32) * float(0.56)
    return c

us_celsius = f_to_c(united_states)
...
# Add your code here.
china, china_temperature = countries[0], temperatures[0]
